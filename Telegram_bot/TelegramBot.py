...
bot = telegram.Bot(token='6336227085:AAEmavX-m--ImFMss2RwachprgBs4rNJ3_8') #Replace TOKEN with your token string

from telegram.ext import Updater, CommandHandler, MessageHandler, Filters

updater = Updater(token='6336227085:AAEmavX-m--ImFMss2RwachprgBs4rNJ3_8', use_context=True) #Replace TOKEN with your token string
